...
//- drive variables
.var anglex   = $10  //x,y,z angle
.var angley   = $11  // 
.var anglez   = $12
.var zoom     = $13  //zoom factor
.var ktoryw   = $15  //actual point in structure
.var dana1    = $16  //for calculations 
//-

.var ypoint   = $17   //moment memory
.var zpoint   = $18   //

.var angx     = $19   //
.var angy     = $1a   // offset for add to angle x,y,z
.var angz     = $1b   //
//-
.var sinx     = $1c   //actual sinus value x,y,z unsigned
.var siny     = $1d
.var sinz     = $1e

.var sinxsign = $1f   //sign of sine x,y,x
.var sinysign = $20
.var sinzsign = $21

.var cosx     = $22    //cosine value unsigned
.var cosy     = $23
.var cosz     = $24

.var cosxsign = $25    //sign of cosine
.var cosysign = $26
.var coszsign = $27

//-
.var xprim    = $28   //for rotations 3d moment values
.var yprim    = $29
.var zprim    = $2a
...
.var zlast    = $2e
//-
.var sign     = $33  //for multiply sign of result

.var mnozna   = $34  //data for multiply
.var mnoznik  = $35
.var liczew   = $36   //actual point in structure


.var tabx2d   = $50   //tab of x,y after perspective
.var taby2d   = $68

.var ilew     = $80   //how many point in structure
.var bryla    = $81   //data structure to calculations
//--------
         .pc= $1000
//--------
//here basic started
...
mtaby2d:
         ...
         .byte $ff,$ff,$ff,$ff,$ff,$ff
//----------------
.var tbadln   = $4000 //tabels addres 

.var strtln   = $3000  //start of buffer
.var endln    = $3800  //end of buffer

.var vline    = $4800 //vertical line draving 
.var fline    = $4d00 //flat line

.var bits     = $e0  //color of line

.var dx       = $32   //delta x,y
.var dy       = $33

.var x1       = $2a   //points of lines to drawing
.var x2       = $2b

.var y1       = $2c
.var y2       = $2d

.var vectr1   = $fb  //vector for read many data (pointer)
//--------
initmltchr:
...
.var driverun = $0300
         *= driverun
         .var offs = save-*
.var ofsetto  = driverun-save
//--------
.label adstart  = save+*-driverun
//---
starter:
         sei
         lda #$7a
