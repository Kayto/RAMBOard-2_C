...
//- drive variables
.const anglex = $10 //x,y,z angle
.const angley = $11 //
.const anglez = $12
.const zoom = $13 //zoom factor
.const ktoryw = $15 //actual point in structure
.const dana1 = $16 //for calculations
//-

.const ypoint = $17 //moment memory
.const zpoint = $18 //

.const angx = $19 //
.const angy = $1a // offset for add to angle x,y,z
.const angz = $1b //
//-
.const sinx = $1c //actual sinus value x,y,z unsigned
.const siny = $1d
.const sinz = $1e

.const sinxsign = $1f //sign of sine x,y,x
.const sinysign = $20
.const sinzsign = $21

.const cosx = $22 //cosine value unsigned
.const cosy = $23
.const cosz = $24

.const cosxsign = $25 //sign of cosine
.const cosysign = $26
.const coszsign = $27

//-
.const xprim = $28 //for rotations 3d moment values
.const yprim = $29
.const zprim = $2a
...
.const zlast = $2e
//-
.const sign = $33 //for multiply sign of result

.const mnozna = $34 //data for multiply
.const mnoznik = $35
.const liczew = $36 //actual point in structure


.const tabx2d = $50 //tab of x,y after perspective
.const taby2d = $68

.const ilew = $80 //how many point in structure
.const bryla = $81 //data structure to calculations
//--------
*= $1000
//--------
//here basic started
...
.byte $ff,$ff,$ff,$ff,$ff,$ff
//----------------
.const tbadln = $4000 //tabels addres

.const strtln = $3000 //start of buffer
.const endln = $3800 //end of buffer

.const vline = $4800 //vertical line draving
.const fline = $4d00 //flat line

.const bits = $e0 //color of line

.const dx = $32 //delta x,y
.const dy = $33

.const x1 = $2a //points of lines to drawing
.const x2 = $2b

.const y1 = $2c
.const y2 = $2d

.const vectr1 = $fb //vector for read many data (pointer)
//--------
initmltchr
...
* = driverun
.offs save-*
.const ofsetto = driverun-save
//--------
.const adstart = save+*-driverun
//---
starter
sei
lda #$7a
